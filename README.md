...
![Interfaz](./docs/img_1.png)
![Interfaz](./docs/img_2.png)
![Interfaz](./docs/img_3.png)
...
Desde la carpeta del proyecto (donde está [main.py](http://main.py)):
